...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var radiosPopupProduct = document.querySelectorAll('.off_canvas-product-radio');
  if (radiosPopupProduct) {
    radiosPopupProduct.forEach(function (radio) {
      radio.addEventListener('change', function () {
        radiosPopupProduct.forEach(function (innerRadio) {
          var parent = innerRadio.closest('.off_canvas-product-input');
